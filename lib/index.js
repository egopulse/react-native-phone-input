...
export default class PhoneInput extends Component {
  ...
  getInputValue = () => {
    return this.state.phoneNumberString;
  }
  ...
  onChangePhone = (value) => {
    this.setState({ phoneNumberString: value });
    if (this.props.onChangePhoneNumber) this.props.onChangePhoneNumber(value);
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]}>
        ...
        >
          <View style={{
            flex: 1, flexDirection: 'row', maxWidth: 45,
            borderBottomWidth: 1,
            ...
            <Image
              ...
              onPress={this.onPressFlag}
            />
            <Image source={require('./images/icon-country-code.png')} />
          </View>
        </TouchableWithoutFeedback>
        <View style={
          {
          ...
          <TextInput
            ...
            autoCorrect={false}
            style={[styles.text, this.props.textStyle, {width: '100%', flex: 1}]}
